...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	/**
	 * Sets the title color shown in tabs.
	 *
	 * @param titleColor
	 * 		Color of the title shown in tabs
	 */
	 ...
	 * 		true to share total width, otherwise as default
	 */
	...
	private void populateTabStrip() {
		...
		for( int i = 0; i < adapter.getCount(); i++ ) {
			...
			if( tabIconView != null ) {
				...
				tabIconView.setImageResource( getResourceIdByName( "ic_" + adapter.getPageTitle( i )
						.toString() ) );
				...
				( (ImageView) tabView ).setImageResource( getResourceIdByName( "ic_" + adapter.getPageTitle( i )
						.toString() ) );
			}
